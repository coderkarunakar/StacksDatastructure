...
#inbuild stack this queue has a class LIFO
q=queue.LifoQueue()
q.put(1)
q.put(2)
q.put(3)
...
#this .empty is  an functionality
while not q.empty():
    ...
    #Note:use this Queue library only for queue ,for stack use list that is better in interwiew